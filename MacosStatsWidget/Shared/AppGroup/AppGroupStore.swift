...
final class AppGroupStore: ObservableObject {
    private static let configurationMutationQueue = DispatchQueue(label: "com.ethansk.macos-stats-widget.configuration-mutations")
    private static let readingsMutationQueue = DispatchQueue(label: "com.ethansk.macos-stats-widget.readings-mutations")
